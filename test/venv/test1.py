...
if age < 30 and 50 < weight < 120:
    print(name + ' ' + surname, age, weight, '- хорошее состояние', sep=',')
elif age > 30 and 50 > weight > 120:
    print(name + ' ' + surname, age, weight, '- заняться собой', sep=',')
elif age >= 40 and 50 >= weight > 120:
    print(name + ' ' + surname, age, weight, "- следует обратиться к врачу!", sep=',')
else:
    print(name + ' ' + surname, age, weight, "- мутант", sep=',')
